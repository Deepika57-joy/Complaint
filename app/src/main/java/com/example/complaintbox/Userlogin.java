...
public class Userlogin extends AppCompatActivity {
            ...
            public void LoginFunction(){
                ...
                if(EditTextEmptyHolder) {
                    ...
                    Toast.makeText(Userlogin.this,"Please Enter UserName or Password.",Toast.LENGTH_LONG).show();
            ...
            public void CheckFinalResult(){
                ...
                if(TempPassword.equalsIgnoreCase(PasswordHolder))
                {
                    ...
                    Toast.makeText(Userlogin.this,"UserName or Password is Wrong, Please Try Again.",Toast.LENGTH_LONG).show();
